...
public class SecretUrlUtil {
    ...
    public static String stationsInfo(String stationIds) {
        ...
        String sysdate = sdf2.format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append(URL);
        buffer.append("?");
    ...
    public static String windT639(String type, String index) {
        ...
        String sysdate = sdf3.format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append(URL);
        buffer.append("?");
    ...
    public static final String airForecast(double lng, double lat) {
        ...
        String start = sdf3.format(timestamp);
        String end = sdf3.format(timestamp+1000*60*60*24);
        StringBuffer buffer = new StringBuffer();
        buffer.append(URL);
    ...
    public static String weatherRadar(String radarCode) {
        final String URL = "http://hfapi.tianqi.cn/data/";
        final String APPID = "fec60dca880595d7";//机密需要用到的AppId
        final String LEID_DATA = "leid_data";//加密秘钥名称
        String time = sdf1.format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append(URL);
        buffer.append("?");
        buffer.append("areaid=").append(radarCode);
        buffer.append("&");
        buffer.append("type=").append("product");
        buffer.append("&");
        buffer.append("date=").append(time);
        buffer.append("&");
        buffer.append("appid=").append(APPID);
