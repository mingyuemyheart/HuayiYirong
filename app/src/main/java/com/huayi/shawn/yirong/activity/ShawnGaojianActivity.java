 ...
 * 稿件
 */
public class ShawnGaojianActivity extends ShawnBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shawn_activity_gaojian);
    ...
    private void initViewPager() {
        Fragment fragment = new ShawnGaojianCheckFragment();
        fragments.add(fragment);
        fragment = new ShawnGaojianAllFragment();
        fragments.add(fragment);
